...
export default function ProjectDetails() {
  ...
  return (
    <div className="h-fit w-full bg-surface-background font-heebo flex flex-row justify-center gap-12   font-heebo  ">
      <div className=" relative bg-surface-secondary w-[700px]  h-fit rounded-[10px] flex flex-col items-center mt-8 ">
                    <div className="w-[700px] h-[250px] rounded-tr-lg rounded-tl-lg flex items-center justify-center" style={{ backgroundImage: 'linear-gradient(to right, #9955E8, #7BFFAF)' }}>
                        <div className="w-10 h-10 absolute top-4 left-4 cursor-pointer bg-surface-background rounded-lg flex justify-center  shadow-shadow2 items-center ">
                            <Link href="/">
                                <Image src="/ArrowLeft.svg" width={30} height={30} />
                                </Link>
                        </div>
                        <Image src={project.cover_photo} width={400} height={400} className="mt-4 ml-7 rounded-lg" />
                    </div>
                    ...
                    <div className="flex flex-col gap-4 mt-4 mb-4 mr-24 ml-24 ">
                        ...
                        <p className="text-text-secondary text-[14x]"><span className='text-[16px] font-semibold'>My role : </span> {project.role}</p>
                        <p className="text-text-secondary text-[14px]"><span className='text-[16px] font-semibold'>Team : </span> {project.team}</p>
        ...
        <div className="  mt-8  w-[300px] h-[130px]  bg-surface-secondary rounded-xl ">
                <div className='flex flex-col mt-5 ml-10 gap-4'>
                    ...
                    {/* <div className=" block bg-button-primary-default w-5/6  text-white p-2 rounded-[9px] flex flex-row justify-between space-x-2 transition-all duration-300 hover:bg-button-primary-hover hover:border-white hover:border-[1px]">
                    <Image src="/GlobeSimple.svg" width={20} height={20}/>
                        <input type="submit" value="Get in touch" className="cursor-pointer outline-none border-none bg-transparent text-white"/>
                        <Image src="/ArrowUpRight.svg" width={20} height={20}/>
                    </div> */}
                    ...
                    <div className=" block bg-surface-primary w-5/6  text-white p-2 rounded-[9px] flex flex-row justify-between items-center transition-all duration-300 hover:bg-surface-primary hover:border-white hover:border-[1px]">
                        ...
                        <Image src="/logo-github 1.svg" width={20} height={20} />
